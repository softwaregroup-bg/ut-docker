...
docker build -f ut.Dockerfile -t nexus-dev.softwaregroup.com:5001/softwaregroup/ut-docker:latest -t nexus-dev.softwaregroup.com:5001/softwaregroup/ut-docker:9.0.0 .
docker build -f impl.Dockerfile -t nexus-dev.softwaregroup.com:5001/softwaregroup/impl-docker:latest -t nexus-dev.softwaregroup.com:5001/softwaregroup/impl-docker:9.0.0 .
